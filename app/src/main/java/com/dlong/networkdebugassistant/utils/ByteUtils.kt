...
object ByteUtils {
    ...
    fun convertObjectToBytes(obj: Any?): ByteArray {
    ...
    @Throws(IOException::class)
    fun convertObjectToBytesByMarshalling(obj: Any?): ByteArray {
        if (obj == null) return byteArrayOf()
        return MarshallingUtils.marshallingWrite(obj)
    }
